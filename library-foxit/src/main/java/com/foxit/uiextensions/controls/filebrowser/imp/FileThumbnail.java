...
public class FileThumbnail {
    ...
    class ThumbnailTask implements Runnable {
        ...
        public void run() {
            ...
            try {
                bitmap = Bitmap.createBitmap(dip2px(38), dip2px(44), Bitmap.Config.RGB_565);
            ...
            synchronized (AppFileUtil.getInstance().isOOMHappened) {
                ...
                try {
                    ...
                    if (pageIndex >= 0 && pageIndex < pdfDoc.getPageCount()) {
                        ...
                        Matrix2D matrix = page.getDisplayMatrix(-position.x, -position.y, viewSize.x, viewSize.y, rotate);
