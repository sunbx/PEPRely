    ...
    private void initView() {
        ...
        for (int i = 0; i < mMenuItems.size(); i++) {
            ...
            if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_COPY) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.rd_am_item_copy_text));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_HIGHLIGHT) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_string_highlight));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_UNDERLINE) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_string_underline));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_STRIKEOUT) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_string_strikeout));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_SQUIGGLY) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_string_squiggly));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_EDIT) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_string_edit));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_STYLE) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_am_style));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_COMMENT) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_string_open));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_REPLY) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_string_reply));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_DELETE) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_string_delete));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_NOTE) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_string_note));
            }else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_SIGNATURE) {
//                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.rd_security_dsg_addSig));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_SIGN) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_string_signature));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_CANCEL) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_string_cancel));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_VERIFY_SIGNATURE) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.rv_security_dsg_verify));
            }  else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_PALY) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.multimedia_play));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_FLATTEN){
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_string_flatten));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_REDACT){
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_string_redaction));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_APPLY){
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.fx_string_apply));
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_SIGN_LIST){
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getApplicationContext().getString(R.string.rv_sign_model));
            }
        }
