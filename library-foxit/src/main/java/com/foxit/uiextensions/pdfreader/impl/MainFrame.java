...
public class MainFrame implements IMainFrame {
    ...
    public ArrayList<View> mStateLayoutList;
...
//                    }
    ...
    private ILayoutChangeListener mLayoutChangeListener = new ILayoutChangeListener() {
        ...
        public void onLayoutChange(View v, int newWidth, int newHeight, int oldWidth, int oldHeight) {
            ...
            if ((orientation == Configuration.ORIENTATION_LANDSCAPE && AppDisplay.getInstance(mContext).getRealNavBarHeight() != 0) || orientation != mLastOrientation){
                mLastOrientation = orientation;
                if (newWidth != oldWidth || newHeight != oldHeight) {
                    mBottomBar.setWidth(newWidth);
                    mBottomBar.updateLayout();
                    mTopBar.setWidth(newWidth);
                    mTopBar.updateLayout();
                    mAnnotBar.setWidth(newWidth);
