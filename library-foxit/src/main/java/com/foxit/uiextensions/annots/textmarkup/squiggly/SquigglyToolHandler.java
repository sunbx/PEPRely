...
public class SquigglyToolHandler implements ToolHandler {
    ...
    protected void addAnnot(final int pageIndex, final boolean addUndo, final ArrayList<RectF> rectArray, final RectF rectF, final SelectInfo selectInfo, final Event.Callback result) {
        ...
        try {
            ...
            com.foxit.sdk.common.fxcrt.RectF rect = new com.foxit.sdk.common.fxcrt.RectF(rectF.left, rectF.bottom, rectF.right, rectF.top);
            annot = (Squiggly) AppAnnotUtil.createAnnot(page.addAnnot(Annot.e_Squiggly, rect), Annot.e_Squiggly);
            if (annot == null) {
                if (!misFromSelector) {
