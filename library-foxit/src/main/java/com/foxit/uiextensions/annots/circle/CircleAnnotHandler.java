        ...
        try {
            ...
            if (needInvalid && mIsModify) {
                ...
                if (mTempLastColor == (int) annot.getBorderColor() && mTempLastLineWidth == annot.getBorderInfo().getWidth() && mTempLastBBox.equals(AppUtil.toRectF(annot.getRect())) && mTempLastOpacity == (int) (((Circle)annot).getOpacity() * 255f)) {
                    modifyAnnot(page.getIndex(), annot, AppUtil.toRectF(annot.getRect()), (int) annot.getBorderColor(), (int) (((Circle)annot).getOpacity() * 255f), annot.getBorderInfo().getWidth(), annot.getContent(),false, false, null);
                } else {
                    modifyAnnot(page.getIndex(), annot, AppUtil.toRectF(annot.getRect()), (int) annot.getBorderColor(), (int) (((Circle)annot).getOpacity() * 255f), annot.getBorderInfo().getWidth(), annot.getContent(),true, true, null);
                }
            } else if (mIsModify) {
