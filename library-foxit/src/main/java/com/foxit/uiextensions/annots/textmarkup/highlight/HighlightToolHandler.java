...
//            quadPoint = new QuadPoints[pointsList.size() / 4];
            for (int i = 0; i < pointsList.size() / 4; i++) {
                com.foxit.sdk.common.fxcrt.PointF point1 = new com.foxit.sdk.common.fxcrt.PointF(pointsList.get(4 * i).x, pointsList.get(4 * i).y);
                com.foxit.sdk.common.fxcrt.PointF point2 = new com.foxit.sdk.common.fxcrt.PointF(pointsList.get(4 * i + 1).x, pointsList.get(4 * i + 1).y);
                com.foxit.sdk.common.fxcrt.PointF point3 = new com.foxit.sdk.common.fxcrt.PointF(pointsList.get(4 * i + 2).x, pointsList.get(4 * i + 2).y);
                com.foxit.sdk.common.fxcrt.PointF point4 = new com.foxit.sdk.common.fxcrt.PointF(pointsList.get(4 * i + 3).x, pointsList.get(4 * i + 3).y);
                quadPoint = new QuadPoints(point1, point2, point3, point4);
