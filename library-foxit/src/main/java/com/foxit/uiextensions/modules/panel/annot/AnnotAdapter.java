...
public class AnnotAdapter extends BaseAdapter {
    ...
    private void flattenNode(AnnotNode node, final Event.Callback callback){
        ...
        UIAnnotFlatten.flattenAnnot(mPdfViewCtrl, annot, callback);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mPdfViewCtrl.getDoc() != null) {
            ...
            int visibility = View.VISIBLE == holder.mItem_ll_reply.getVisibility() ||
                    ...
                    View.VISIBLE == holder.mItem_ll_delete.getVisibility() ? View.VISIBLE : View.GONE;
            holder.mItemMore.setVisibility(visibility);
