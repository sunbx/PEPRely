...
public class CropView {
    ...
    class OverlayView extends View implements Runnable{
        ...
        protected void onDraw(Canvas canvas) {
            ...
            drawWrapperData(canvas, mCropViewCtrl.getCurrentPage(), mBitmap.getWidth(), mBitmap.getHeight());
        }
        ...
        public void run() {
            ...
            try {
                ...
                if (pdfDoc.isCDRM() &&
                        !documentManager.isAccessPage(mCropViewCtrl.getCurrentPage())) {
        ...
        private void drawWrapperData(Canvas canvas, int pageIndex, int width, int height) {
            try {
                DocumentManager documentManager = ((UIExtensionsManager) mCropViewCtrl.getUIExtensionsManager()).getDocumentManager();
                if (mCropViewCtrl.getDoc().isCDRM() &&
